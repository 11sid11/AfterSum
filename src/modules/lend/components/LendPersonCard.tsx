    ...
    >
      ...
      <div className="shrink-0 text-right">
        <div className="flex items-center justify-end gap-1.5">
          {balanceMinor === 0 && <span className="grid h-4 w-4 place-items-center rounded-full bg-emerald-500/12 text-emerald-600 dark:text-emerald-300"><Check size={10} strokeWidth={2.8} /></span>}
